...
if(isset($arResult['LEGEND']))
{
	...
	?><a href="#" onclick="BX.Crm.DealCategoryChanger.getByEntityId(<?=$arResult['ENTITY_ID']?>).process(); return false;">
...
?>
<?php
$APPLICATION->AddHeadScript('//code.jquery.com/jquery-2.2.4.min.js');
$APPLICATION->AddHeadScript('//code.jquery.com/ui/1.12.1/jquery-ui.js');
?>
<script type="text/javascript">
	$(document).ready(function(){
		//alert();
		if($("input[name='UF_PROFIT']").length){
			alert('!!!');
		}
		$("input[name='UF_PROFIT']").prop("disabled", false);
		$("input[name='UF_PROFIT']").val('10');
